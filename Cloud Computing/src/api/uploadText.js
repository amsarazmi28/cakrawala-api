...
exports.uploadText = async (req, res) => {
  ...
  // Database
  await db.promise().query(`INSERT INTO uploads (raw_file, raw_filename, processed_file, processed_filename, result_file, user_id) VALUES('${publicUrl}', '${fileName}', '${publicUrl}', '${fileName}' , 'generated by ai', ${id})`);
